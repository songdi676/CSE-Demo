...
public class PojoClient {
	...
	/**
	 * Only in http transport, traceId will be set to invocation if null. But in
	 * highway, nothing done.
	 */
	...
	private static void testSmartCare(SmartCare smartCare) {
		...
		TestMgr.check("resultCode: 1\nresultMessage: delete application app0 failed", smartCare.delApplication("app0"));
	}
	...
	private static void testCommonInvoke(String transport) {
		...
		result = InvokerUtils.syncInvoke("pojo", "0.0.4", transport, "server", "splitParam",
